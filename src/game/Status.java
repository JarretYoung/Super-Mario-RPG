...
public enum Status {
    ...
    DROP_FIRE_WHEN_ATTACK, PLAYER, TELEPORTATION_GROUND, FOUNTAIN, HAS_FULL_BOTTLE, GAME_COMPLETE // used to indicate that the Princess is saved and the game is over
}
